...
public class principale2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hmwelcome.setText("Willkommen " + lname );
        upcloan.setText("€ " + applied + ",00");
        limittxt.setText("€ " + limit + ",00");
        hmbalance.setText("Kontostand: €" + balance );
        ...
        if (!Conectivity.isConnectingToInternet(principale2.this)) {
            Toast.makeText(principale2.this, "Bitte überprüfe deine Internetverbindung", Toast.LENGTH_SHORT).show();
        }
