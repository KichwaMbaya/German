            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 33) {
                    ...
                    if (ContextCompat.checkSelfPermission(applicato_successo.this,
                        ...
                        dialog.setMessage("Bitte erlauben Sie Benachrichtigungen für diese App, damit Sie " +
                                "benachrichtigt werden, wenn Ihr Kredit bereit ist");
                        dialog.setPositiveButton("IN ORDNUNG", new DialogInterface.OnClickListener() {
                            @Override
