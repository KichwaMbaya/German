...
public class prestito_periodo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amount_tit.setText("Sie sind dabei, einen Kredit in Höhe von zu beantragen €" + string + ".");
        ...
        radioGroup1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (!string.isEmpty()){
                    ...
                    repayment.setText("Du wirst zahlen: €" + deni);
                }
            }
        });
        applydonkey.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (months3.isChecked() || months4.isChecked() || months5.isChecked()
                    ...
                    progressDialog.setMessage("Einreichen Ihres Kreditantrags.");
                ...
                Toast.makeText(prestito_periodo.this, "Zeitraum auswählen", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        TimerTask ttno = new TimerTask() {
            ...
            public void run() {
                ...
                if (counternot == 100) {
                    ...
                    editor.putString("notification", "Glückwunsch!! Ihr Kreditantrag wurde genehmigt. Sie sind nur noch wenige letzte " +
                            "Schritte entfernt, bevor Sie Ihren Kredit erhalten können. Klicken Sie auf diese Benachrichtigung, um weitere " +
