        ...
        Morelgtbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!Conectivity.isConnectingToInternet(lista_delle_vivande.this)) {
                    Toast.makeText(lista_delle_vivande.this, "Bitte überprüfe deine Internetverbindung", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(lista_delle_vivande.this, "Abgemeldet", Toast.LENGTH_SHORT).show();
